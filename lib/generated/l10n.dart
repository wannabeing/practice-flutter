...
class S {
  ...
  /// `{value}`
  String videoComments(int value) {
    final NumberFormat valueNumberFormat = NumberFormat.compact(
      locale: Intl.getCurrentLocale(),
    );
    final String valueString = valueNumberFormat.format(value);
  ...
  /// `{value}`
  String videoCommentLikes(int value) {
    final NumberFormat valueNumberFormat = NumberFormat.compact(
      locale: Intl.getCurrentLocale(),
    );
    final String valueString = valueNumberFormat.format(value);
  ...
  /// `{value}`
  String videoCommentDate(DateTime value) {
    final DateFormat valueDateFormat =
        DateFormat('compact', Intl.getCurrentLocale());
